...
namespace TowerBreakers.Player.Data.SO
{
    ...
    public class ArmorData : ScriptableObject
    {
        ...
        [Header("애니메이션 설정")]
        [SerializeField, Tooltip("피격 시 재생할 애니메이션 클립 (DAMAGED_List[0] 교체용)")]
        private AnimationClip m_damagedClip;

        [SerializeField, Tooltip("사망 시 재생할 애니메이션 클립 (DEATH_List[0] 교체용)")]
        ...
        public AnimationClip DamagedClip => m_damagedClip;
        public AnimationClip DeathClip => m_deathClip;
